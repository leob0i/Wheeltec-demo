...
const palvelut = [
  ...
  },
  {
    ...
    hinta: "alk. 350 €",
    img: "/images/porsche.keskio.webp",
    kuvaus:
      "Naarmuuntunut keskiö kerää ruostetta ja muuta pinttynyttä likaa ja voi aiheuttaa lakan irtoamisen.",
  },
  {
    id: "03",
    nimi: "Lipan kiilloitus",
    hinta: "alk. 70 € / lippa",
    img: "/images/lippa.webp",
    kuvaus:
...
const prosessi = [
  {
    ...
    otsikko: "Arvio",
    teksti:
      "Lähetä kuva tai tuo vanne. Katsotaan kunto ja mitä tehdään. ",
  },
  {
    n: "02",
