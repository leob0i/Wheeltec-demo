...
const palvelut = [
  ...
  {
    id: "02",
    nimi: "Vanteen keskiöt, sarja",
    hinta: "alk. 350 €",
    img: "/images/kultanen.vanne.webp",
    kuvaus:
      "Vanteen huomiopisteet kiillotettuina. Sopii erityisesti kun haluat korostaa rimmin rakennetta tai täydentää muuta käsittelyä.",
  },
  {
    id: "03",
    nimi: "Lipan kiilloitus",
    hinta: "alk. 70 € / lippa",
    img: "/images/moottorinosat.jpeg",
    kuvaus:
      "Jokainen lippa käsin viimeisteltynä. Joissakin tapauksissa vanteeseen asennetaan uusi lippa, jos vanha on liian kulunut kiillotettavaksi.",
  },
]
...
const prosessi = [
  {
    ...
    otsikko: "Arvio",
    teksti:
      "Tuot vanteet — katsotaan kunto ja sovitaan lopputuloksesta. Ei lupauksia ennen kuin vanne on käsissä.",
  },
  {
    n: "02",
    otsikko: "Esikäsittely",
    teksti:
      "Vanne puhdistetaan, hiekkapuhalletaan tarvittaessa ja pinnan virheet tasoitetaan huolellisesti ennen kiilloitusta.",
  },
  {
    n: "03",
    otsikko: "Kiilloitus",
    teksti:
      "Tärykiilloitus hioo metallin pinnasta kaiken ylimääräisen. Lopputuloksena lähes peilitasoinen, tasainen pinta.",
  },
  {
    n: "04",
    otsikko: "Viimeistely",
    teksti:
      "Pinta suojataan ja kiilto tarkistetaan käsin. Valmis luovutettavaksi — sellainen kuin pitääkin.",
  },
]

export default function KiilloitusPage() {
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-end px-4 md:px-8 lg:px-12 pb-16 md:pb-24">
        <div className="max-w-[1400px] mx-auto w-full text-center md:text-left">
          ...
          <div className="overflow-hidden mb-3 md:mb-4">
            <h1
              className="font-sans text-[21vw] sm:text-[17vw] md:text-[14vw] lg:text-[12vw] leading-none tracking-[-0.04em] uppercase anim-shutter-up shimmer-text"
              style={d(400)}
            >
              Kiilloitus
            </h1>
      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div>
            ...
            >
              Tärykiilloitus<br />vanteille<span className="text-accent">.</span>
            </h2>
            ...
            >
              <p className="font-mono text-[11px] md:text-sm text-foreground/60 leading-relaxed">
                Tärykiilloitus on ammattimainen metallinkäsittelymenetelmä, jossa vanteet kiilloitetaan pyörivässä rummussa hioma-aineen avulla. Prosessi käy läpi jokaisen pinnan tasaisesti — myös kuperien muotojen ja reunojen, joihin käsinkiilloitus ei yllä kunnolla.
              </p>
              <p className="font-mono text-[11px] md:text-sm text-foreground/60 leading-relaxed">
                Tulos on metallin oma kirkas pinta ilman lakkaa tai pinnoitetta. Tärykiilloitettu vanne ei himmenee yhtä nopeasti kuin käsin kiilloitettu, koska pinta on mekaanisesti tasainen eikä jätä mikroskooppisia naarmuja joihin lika tarttuu.
              </p>
              <p className="font-mono text-[11px] md:text-sm text-foreground leading-relaxed">
                Wheeltecillä kiilloitamme sekä kokonaisia vannesarjoja että yksittäisiä lippoja. Jos vanha lippa on liian kulunut kiillotettavaksi, asennamme uuden tilalle.
              </p>
            </div>
          </div>
          ...
          >
            <div className="border border-foreground/[0.08] overflow-hidden group">
              ...
              <div className="p-6 border-t border-foreground/[0.08]">
                <div className="flex items-start justify-between gap-4 mb-3">
                  <h3 className="font-sans text-2xl lg:text-3xl tracking-tighter uppercase leading-none">
                    {palvelut[0].nimi}
                  </h3>
                  <span className="font-sans text-xl lg:text-2xl tracking-tighter text-accent shrink-0">
                    {palvelut[0].hinta}
                  </span>
                </div>
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto relative">
        {/* Header */}
        <div
          className={`mb-5 md:mb-10 transition-all duration-700 ${
            visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
          }`}
        >
        ...
        <div className="border-b border-border">
          {palvelut.map((p, i) => (
            <div
              key={p.id}
              className={`py-6 md:py-10 border-t border-foreground/5 group hover:bg-foreground/[0.02] transition-all px-0 md:px-4 ${i === 0 ? "lg:hidden" : ""} ${
            ...
            >
              {/* Image */}
              <div className="relative w-full overflow-hidden mb-4 md:mb-6 aspect-[16/6] md:aspect-[16/5]">
                <Image
                  src={p.img}
                  alt={p.nimi}
                  fill
      ...
      <div className="max-w-[800px] mx-auto relative z-10">
        ...
        >
          <h2 className="font-sans text-[12vw] sm:text-5xl md:text-7xl tracking-tighter uppercase leading-[0.9] mb-8 md:mb-12">
            Tilaa<br className="md:hidden" /> kiilloitus<span className="text-accent">.</span>
          </h2>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3 md:gap-5">
              ...
              <div className="flex flex-col gap-1">
                ...
                <textarea
                  required
                  rows={4}
                  placeholder="Pyydä tarjous, sovi vanteen huolto tai kysy lisää — kerro minkä käsittelyn tarvitset ja mille vanteille."
