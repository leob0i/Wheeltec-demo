      ...
      <div className="max-w-[800px] mx-auto relative z-10">
        ...
        >
          <h2 className="font-sans text-[12vw] sm:text-5xl md:text-7xl tracking-tighter uppercase leading-[0.9] mb-8 md:mb-12">
            Tilaa<br className="md:hidden" /> maalinpoisto<span className="text-accent">.</span>
          </h2>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3 md:gap-5">
              ...
              <div className="flex flex-col gap-1">
                ...
                <textarea
                  required
                  rows={4}
                  placeholder="Kerro mitä osia haluat käsitellä — kemiallinen maalinpoisto, hiekkapuhallus vai molemmat."
